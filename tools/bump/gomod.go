...
// quickGate is the cheapest signal that a dependency set is viable. It runs
// once per bisect step, so it trades depth for speed; the nix checks in gate1
// cover the rest of the tree afterwards.
func quickGate(ctx context.Context, r *repo) error {
